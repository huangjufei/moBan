...
<br/>
	...
	<form name="form1" id="form1" action="updateDriver.do" method="post" enctype="multipart/form-data" class="form-horizontal" >
		...
		<input type="hidden" name="driverId" value="${driver.driverId}">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<select id="selectIIsshow" name="areaId" class="form-control">					
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<!-- 
				<input type="radio" name="driverSex" value="" <c:if test="${driver.driverSex == 1}">checked</c:if> > 男
				<input type="radio" name="driverSex" value="" <c:if test="${driver.driverSex == 0}">checked</c:if> > 女
		        -->
		        <c:if test="${driver.driverSex == 1}">		        
					<input type="radio" name="driverSex" value="1"  checked="checked"> 男
					<input type="radio" name="driverSex" value="0" > 女
					
		        </c:if>
		        
		           <c:if test="${driver.driverSex == 0}">		        
					<input type="radio" name="driverSex" value="0" checked="checked"> 女
					<input type="radio" name="driverSex" value="1" > 男
		        </c:if>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label"><i class="red">*</i>上传教练个人风采图片(可选多张)</label>
				<input  type="text" disabled="disabled"  maxlength="30" placeholder="图片无需修改,可以不选">
