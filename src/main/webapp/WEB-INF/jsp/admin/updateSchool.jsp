...
<br>
	...
	<form action="updateSchool.do" method="post" enctype="multipart/form-data" class="form-horizontal" >
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input class="form-control inputNeedCheck"  maxlength="20" type="text" name="schoolName" value="${school.schoolName}" disabled="disabled"/>
			</div>
		</div>
